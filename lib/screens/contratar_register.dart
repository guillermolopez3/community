...
class ContratarRegister extends StatefulWidget {
  @override
  _ContratarRegisterState createState() => _ContratarRegisterState();
}

class _ContratarRegisterState extends State<ContratarRegister> {
          ...
          children: <Widget>[
            ...
            Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  _myTextForm('Correo Electrónico', 'Correo Electrónico *', type: TextInputType.emailAddress),
